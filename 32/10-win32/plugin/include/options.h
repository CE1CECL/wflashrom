...
enum opt_code
{
  ...
  OPT_fuse_ld_mold = 1564,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1565,             /* -fuse-linker-plugin */
  OPT_fuselist = 1566,                       /* -fuselist */
  OPT_fvar_tracking = 1567,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1568,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1569,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1570,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1571,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1572, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1573,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1574,                   /* -fverbose-asm */
  /* OPT_fversion = 1575, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1576,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1577,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1578,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1579,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1580,                   /* -fvisibility= */
  OPT_fvpt = 1581,                           /* -fvpt */
  OPT_fvtable_gc = 1582,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1583,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1584,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1585,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1586,                     /* -fvtv-debug */
  OPT_fweak = 1587,                          /* -fweak */
  OPT_fweb = 1588,                           /* -fweb */
  /* OPT_fwhole_file = 1589, */              /* -fwhole-file */
  OPT_fwhole_program = 1590,                 /* -fwhole-program */
  OPT_fwholediv = 1591,                      /* -fwholediv */
  OPT_fwholevalue = 1592,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1593,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1594,             /* -fworking-directory */
  OPT_fwpa = 1595,                           /* -fwpa */
  OPT_fwpa_ = 1596,                          /* -fwpa= */
  OPT_fwrapv = 1597,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1598,                 /* -fwrapv-pointer */
  OPT_fwritable_relocated_rdata = 1599,      /* -fwritable-relocated-rdata */
  OPT_fxcode = 1600,                         /* -fxcode */
  OPT_fxref = 1601,                          /* -fxref */
  /* OPT_fzee = 1602, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1603,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1604,                     /* -fzero-link */
  OPT_g = 1605,                              /* -g */
  OPT_gant = 1606,                           /* -gant */
  OPT_gas_loc_support = 1607,                /* -gas-loc-support */
  OPT_gas_locview_support = 1608,            /* -gas-locview-support */
  OPT_gcoff = 1609,                          /* -gcoff */
  OPT_gcoff1 = 1610,                         /* -gcoff1 */
  OPT_gcoff2 = 1611,                         /* -gcoff2 */
  OPT_gcoff3 = 1612,                         /* -gcoff3 */
  OPT_gcolumn_info = 1613,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1614,                 /* -gdescribe-dies */
  OPT_gdwarf = 1615,                         /* -gdwarf */
  OPT_gdwarf_ = 1616,                        /* -gdwarf- */
  OPT_gen_decls = 1617,                      /* -gen-decls */
  OPT_ggdb = 1618,                           /* -ggdb */
  OPT_ggnu_pubnames = 1619,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1620,                   /* -gimple-stats */
  OPT_ginline_points = 1621,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1622, /* -ginternal-reset-location-views */
  OPT_gnat = 1623,                           /* -gnat */
  OPT_gnatO = 1624,                          /* -gnatO */
  OPT_gno_ = 1625,                           /* -gno- */
  OPT_gno_pubnames = 1626,                   /* -gno-pubnames */
  OPT_gpubnames = 1627,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1628,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1629,                   /* -gsplit-dwarf */
  OPT_gstabs = 1630,                         /* -gstabs */
  OPT_gstabs_ = 1631,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1632,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1633,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1634,                        /* -gtoggle */
  OPT_gvariable_location_views = 1635,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1636,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1637,                           /* -gvms */
  OPT_gxcoff = 1638,                         /* -gxcoff */
  OPT_gxcoff_ = 1639,                        /* -gxcoff+ */
  OPT_gz = 1640,                             /* -gz */
  OPT_gz_ = 1641,                            /* -gz= */
  OPT_h = 1642,                              /* -h */
  OPT_help = 1643,                           /* -help */
  OPT_idirafter = 1644,                      /* -idirafter */
  OPT_imacros = 1645,                        /* -imacros */
  OPT_imultiarch = 1646,                     /* -imultiarch */
  OPT_imultilib = 1647,                      /* -imultilib */
  OPT_include = 1648,                        /* -include */
  OPT_iplugindir_ = 1649,                    /* -iplugindir= */
  OPT_iprefix = 1650,                        /* -iprefix */
  OPT_iquote = 1651,                         /* -iquote */
  OPT_isysroot = 1652,                       /* -isysroot */
  OPT_isystem = 1653,                        /* -isystem */
  OPT_iwithprefix = 1654,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1655,              /* -iwithprefixbefore */
  OPT_k8 = 1656,                             /* -k8 */
  OPT_l = 1657,                              /* -l */
  OPT_lang_asm = 1658,                       /* -lang-asm */
  OPT_list = 1659,                           /* -list */
  OPT_m128bit_long_double = 1660,            /* -m128bit-long-double */
  OPT_m16 = 1661,                            /* -m16 */
  OPT_m32 = 1662,                            /* -m32 */
  OPT_m3dnow = 1663,                         /* -m3dnow */
  OPT_m3dnowa = 1664,                        /* -m3dnowa */
  OPT_m64 = 1665,                            /* -m64 */
  OPT_m80387 = 1666,                         /* -m80387 */
  OPT_m8bit_idiv = 1667,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1668,             /* -m96bit-long-double */
  OPT_mabi_ = 1669,                          /* -mabi= */
  OPT_mabm = 1670,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1671,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1672,                 /* -maddress-mode= */
  OPT_madx = 1673,                           /* -madx */
  OPT_maes = 1674,                           /* -maes */
  OPT_malign_data_ = 1675,                   /* -malign-data= */
  OPT_malign_double = 1676,                  /* -malign-double */
  OPT_malign_functions_ = 1677,              /* -malign-functions= */
  OPT_malign_jumps_ = 1678,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1679,                  /* -malign-loops= */
  OPT_malign_stringops = 1680,               /* -malign-stringops */
  OPT_march_ = 1681,                         /* -march= */
  OPT_masm_ = 1682,                          /* -masm= */
  OPT_mavx = 1683,                           /* -mavx */
  OPT_mavx2 = 1684,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1685,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1686,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1687,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1688,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1689,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1690,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1691,                      /* -mavx512bw */
  OPT_mavx512cd = 1692,                      /* -mavx512cd */
  OPT_mavx512dq = 1693,                      /* -mavx512dq */
  OPT_mavx512er = 1694,                      /* -mavx512er */
  OPT_mavx512f = 1695,                       /* -mavx512f */
  OPT_mavx512ifma = 1696,                    /* -mavx512ifma */
  OPT_mavx512pf = 1697,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1698,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1699,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1700,                      /* -mavx512vl */
  OPT_mavx512vnni = 1701,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1702,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1703,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1704,                           /* -mbmi */
  OPT_mbmi2 = 1705,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1706,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1707,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1708,                    /* -mcet-switch */
  OPT_mcld = 1709,                           /* -mcld */
  OPT_mcldemote = 1710,                      /* -mcldemote */
  OPT_mclflushopt = 1711,                    /* -mclflushopt */
  OPT_mclwb = 1712,                          /* -mclwb */
  OPT_mclzero = 1713,                        /* -mclzero */
  OPT_mcmodel_ = 1714,                       /* -mcmodel= */
  OPT_mconsole = 1715,                       /* -mconsole */
  /* OPT_mcpu_ = 1716, */                    /* -mcpu= */
  OPT_mcrc32 = 1717,                         /* -mcrc32 */
  OPT_mcx16 = 1718,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1719,            /* -mdispatch-scheduler */
  OPT_mdll = 1720,                           /* -mdll */
  OPT_mdump_tune_features = 1721,            /* -mdump-tune-features */
  OPT_menqcmd = 1722,                        /* -menqcmd */
  OPT_mf16c = 1723,                          /* -mf16c */
  OPT_mfancy_math_387 = 1724,                /* -mfancy-math-387 */
  OPT_mfentry = 1725,                        /* -mfentry */
  OPT_mfentry_name_ = 1726,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1727,               /* -mfentry-section= */
  OPT_mfma = 1728,                           /* -mfma */
  OPT_mfma4 = 1729,                          /* -mfma4 */
  OPT_mforce_drap = 1730,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1731,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1732,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1733,                       /* -mfpmath= */
  OPT_mfsgsbase = 1734,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1735,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1736, */              /* -mfused-madd */
  OPT_mfxsr = 1737,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1738,             /* -mgeneral-regs-only */
  OPT_mgfni = 1739,                          /* -mgfni */
  OPT_mhard_float = 1740,                    /* -mhard-float */
  OPT_mhle = 1741,                           /* -mhle */
  OPT_miamcu = 1742,                         /* -miamcu */
  OPT_mieee_fp = 1743,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1744,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1745,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1746,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1747,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1748,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1749,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1750, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1751,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1752,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1753,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1754,                /* -mlong-double-80 */
  OPT_mlwp = 1755,                           /* -mlwp */
  OPT_mlzcnt = 1756,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1757,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1758,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1759,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1760,                  /* -mmitigate-rop */
  OPT_mmmx = 1761,                           /* -mmmx */
  OPT_mmovbe = 1762,                         /* -mmovbe */
  OPT_mmovdir64b = 1763,                     /* -mmovdir64b */
  OPT_mmovdiri = 1764,                       /* -mmovdiri */
  OPT_mmpx = 1765,                           /* -mmpx */
  OPT_mms_bitfields = 1766,                  /* -mms-bitfields */
  OPT_mmwaitx = 1767,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1768,            /* -mno-align-stringops */
  OPT_mno_default = 1769,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1770,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1771,                  /* -mno-push-args */
  OPT_mno_red_zone = 1772,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1773,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1774,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1775,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1776,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1777,                          /* -mpc32 */
  OPT_mpc64 = 1778,                          /* -mpc64 */
  OPT_mpc80 = 1779,                          /* -mpc80 */
  OPT_mpclmul = 1780,                        /* -mpclmul */
  OPT_mpcommit = 1781,                       /* -mpcommit */
  OPT_mpconfig = 1782,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1783,            /* -mpe-aligned-commons */
  OPT_mpku = 1784,                           /* -mpku */
  OPT_mpopcnt = 1785,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1786, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1787,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1788,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1789,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1790,                        /* -mprfchw */
  OPT_mptwrite = 1791,                       /* -mptwrite */
  OPT_mpush_args = 1792,                     /* -mpush-args */
  OPT_mrdpid = 1793,                         /* -mrdpid */
  OPT_mrdrnd = 1794,                         /* -mrdrnd */
  OPT_mrdseed = 1795,                        /* -mrdseed */
  OPT_mrecip = 1796,                         /* -mrecip */
  OPT_mrecip_ = 1797,                        /* -mrecip= */
  OPT_mrecord_mcount = 1798,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1799,                 /* -mrecord-return */
  OPT_mred_zone = 1800,                      /* -mred-zone */
  OPT_mregparm_ = 1801,                      /* -mregparm= */
  OPT_mrtd = 1802,                           /* -mrtd */
  OPT_mrtm = 1803,                           /* -mrtm */
  OPT_msahf = 1804,                          /* -msahf */
  OPT_msgx = 1805,                           /* -msgx */
  OPT_msha = 1806,                           /* -msha */
  OPT_mshstk = 1807,                         /* -mshstk */
  OPT_mskip_rax_setup = 1808,                /* -mskip-rax-setup */
  OPT_msoft_float = 1809,                    /* -msoft-float */
  OPT_msse = 1810,                           /* -msse */
  OPT_msse2 = 1811,                          /* -msse2 */
  OPT_msse2avx = 1812,                       /* -msse2avx */
  OPT_msse3 = 1813,                          /* -msse3 */
  OPT_msse4 = 1814,                          /* -msse4 */
  OPT_msse4_1 = 1815,                        /* -msse4.1 */
  OPT_msse4_2 = 1816,                        /* -msse4.2 */
  OPT_msse4a = 1817,                         /* -msse4a */
  /* OPT_msse5 = 1818, */                    /* -msse5 */
  OPT_msseregparm = 1819,                    /* -msseregparm */
  OPT_mssse3 = 1820,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1821,               /* -mstack-arg-probe */
  ...
  OPT_mstack_protector_guard_symbol_ = 1824, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1825,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1826,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1827,            /* -mstringop-strategy= */
  OPT_mstv = 1828,                           /* -mstv */
  OPT_mtbm = 1829,                           /* -mtbm */
  OPT_mthreads = 1830,                       /* -mthreads */
  OPT_mtls_dialect_ = 1831,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1832,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1833,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1834,                         /* -mtune= */
  OPT_municode = 1835,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1836,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1837,                          /* -mvaes */
  OPT_mveclibabi_ = 1838,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1839,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1840,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1841,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1842,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1843,                      /* -mwbnoinvd */
  OPT_mwin32 = 1844,                         /* -mwin32 */
  OPT_mwindows = 1845,                       /* -mwindows */
  OPT_mx32 = 1846,                           /* -mx32 */
  OPT_mxop = 1847,                           /* -mxop */
  OPT_mxsave = 1848,                         /* -mxsave */
  OPT_mxsavec = 1849,                        /* -mxsavec */
  OPT_mxsaveopt = 1850,                      /* -mxsaveopt */
  OPT_mxsaves = 1851,                        /* -mxsaves */
  OPT_n = 1852,                              /* -n */
  OPT_name_sort = 1853,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1854,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1855,              /* -no-integrated-cpp */
  OPT_no_pie = 1856,                         /* -no-pie */
  OPT_no_pthread = 1857,                     /* -no-pthread */
  ...
  OPT_o = 1866,                              /* -o */
  OPT_objects = 1867,                        /* -objects */
  OPT_p = 1868,                              /* -p */
  OPT_pass_exit_codes = 1869,                /* -pass-exit-codes */
  /* OPT_pedantic = 1870, */                 /* -pedantic */
  OPT_pedantic_errors = 1871,                /* -pedantic-errors */
  OPT_pg = 1872,                             /* -pg */
  OPT_pie = 1873,                            /* -pie */
  OPT_pipe = 1874,                           /* -pipe */
  OPT_posix = 1875,                          /* -posix */
  ...
  OPT_pthread = 1888,                        /* -pthread */
  OPT_quiet = 1889,                          /* -quiet */
  OPT_r = 1890,                              /* -r */
  ...
  OPT_std_gnu__98 = 1949,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1950,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1951,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1952, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1953, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1954,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1955, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1956,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1957,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1958, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1959, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1960,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1961, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1962, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1963, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1964, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1965, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1966,                     /* -std=legacy */
