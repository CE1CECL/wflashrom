...
const char * LIB_PATH_VALUE   = "D:\\32\\libusb-1.0.23\\libusb\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\32\\libusb-1.0.23\\libusb\\.libs;D:\\32\\L\\lib;D:\\32\\L\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/32/libusb-1.0.23/libusb/.libs:/32/L/lib:/32/L/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/32/libusb-1.0.23/libusb/.libs:$PATH\"\n", f);
  fputs ("\n", f);
