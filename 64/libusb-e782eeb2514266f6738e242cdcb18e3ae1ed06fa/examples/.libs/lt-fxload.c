...
/* ./.libs/lt-fxload.c - temporary wrapper executable for .libs/fxload.exe
   Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-4

   The fxload program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "fxload.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# fxload - temporary wrapper script for .libs/fxload.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-4\n", f);
  fputs ("#\n", f);
  fputs ("# The fxload program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"fxload.exe:fxload:$LINENO: libtool wrapper (GNU libtool) 2.4.7 Debian", f);
  fputs ("-2.4.7-4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"fxload.exe:fxload:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"fxload.exe:fxload:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
