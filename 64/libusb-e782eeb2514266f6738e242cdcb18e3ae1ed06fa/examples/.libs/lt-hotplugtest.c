...
/* ./.libs/lt-hotplugtest.c - temporary wrapper executable for .libs/hotplugtest.exe
   Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-4

   The hotplugtest program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "D:\\64\\libusb-e782eeb2514266f6738e242cdcb18e3ae1ed06fa\\libusb\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\64\\libusb-e782eeb2514266f6738e242cdcb18e3ae1ed06fa\\libusb\\.libs;D:\\64\\L\\lib;D:\\64\\L\\bin;";
const char * TARGET_PROGRAM_NAME = "hotplugtest.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.7 Debian-2.4.7-4\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# hotplugtest - temporary wrapper script for .libs/hotplugtest.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-4\n", f);
  fputs ("#\n", f);
  fputs ("# The hotplugtest program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../libusb/libusb-1.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"hotplugtest.exe:hotplugtest:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.7 Debian-2.4.7-4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"hotplugtest.exe:hotplugtest:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"hotplugtest.exe:hotplugtest:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
  ...
  fputs ("    PATH=/64/libusb-e782eeb2514266f6738e242cdcb18e3ae1ed06fa/libusb/.libs:/64/L", f);
  fputs ("/lib:/64/L/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/64/libusb-e782eeb2514266f6738e242cdcb18e3ae1ed06fa/libusb/.libs:$PAT", f);
  fputs ("H\"\n", f);
  fputs ("\n", f);
