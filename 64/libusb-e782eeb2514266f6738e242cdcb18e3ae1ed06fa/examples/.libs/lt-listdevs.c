...
/* ./.libs/lt-listdevs.c - temporary wrapper executable for .libs/listdevs.exe
   Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-4

   The listdevs program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "listdevs.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# listdevs - temporary wrapper script for .libs/listdevs.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-4\n", f);
  fputs ("#\n", f);
  fputs ("# The listdevs program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"listdevs.exe:listdevs:$LINENO: libtool wrapper (GNU libtool) 2.4.7 De", f);
  fputs ("bian-2.4.7-4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"listdevs.exe:listdevs:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"listdevs.exe:listdevs:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
