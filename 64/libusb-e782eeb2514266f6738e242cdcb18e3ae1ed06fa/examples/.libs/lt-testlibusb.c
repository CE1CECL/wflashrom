...
/* ./.libs/lt-testlibusb.c - temporary wrapper executable for .libs/testlibusb.exe
   Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-4

   The testlibusb program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "testlibusb.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# testlibusb - temporary wrapper script for .libs/testlibusb.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-4\n", f);
  fputs ("#\n", f);
  fputs ("# The testlibusb program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"testlibusb.exe:testlibusb:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("7 Debian-2.4.7-4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testlibusb.exe:testlibusb:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testlibusb.exe:testlibusb:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
