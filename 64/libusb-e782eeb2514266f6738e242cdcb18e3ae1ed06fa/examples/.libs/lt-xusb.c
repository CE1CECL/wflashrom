...
/* ./.libs/lt-xusb.c - temporary wrapper executable for .libs/xusb.exe
   Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-4

   The xusb program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "xusb.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# xusb - temporary wrapper script for .libs/xusb.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-4\n", f);
  fputs ("#\n", f);
  fputs ("# The xusb program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"xusb.exe:xusb:$LINENO: libtool wrapper (GNU libtool) 2.4.7 Debian-2.4", f);
  fputs (".7-4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"xusb.exe:xusb:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"xusb.exe:xusb:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
